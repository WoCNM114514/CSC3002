...
std::map<std::string,std::string> createMorseCodeMap();
...
const std::map<std::string,std::string> LETTERS_TO_MORSE = createMorseCodeMap();
const std::map<std::string,std::string> MORSE_TO_LETTERS = invertMap(LETTERS_TO_MORSE);
